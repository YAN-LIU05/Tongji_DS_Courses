...
public:
	...
	config_file_tools(const char* const cfgname, const enum BREAK_CTYPE _ctype = BREAK_CTYPE::Equal);
	config_file_tools(const string& cfgname, const enum BREAK_CTYPE _ctype = BREAK_CTYPE::Equal);
	...
	friend int read_cfgfile(config_file_tools& cfg);
};
