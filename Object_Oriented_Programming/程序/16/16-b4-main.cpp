...
/***************************************************************************
  ...
  输入参数：
  返 回 值：
  说    明：main函数不准动，也不需要提交，检查时会替换（细节可能有错，如果发现请及时提出并自行更正）
***************************************************************************/
int main()
{
	if (1) {
	...
	if (1) {
		...
		d1.set(2024, 11, 22);	//2024.11.22
		d2.set(2024, 11);		//2024.11.1
		d3.set(2024);		    //2024.1.1

		cout << "d1应该是2024.11.22，实际为：";
		d1.show();
		cout << "d2应该是2024.11,1， 实际为：";
		d2.show();
		cout << "d3应该是2024.1.1，  实际为：";
		d3.show();
	...
	if (1) {
		Date d1(2024, 11, 22), d2(d1), d3(d1);

		cout << "测试set，部分不变" << endl;

		d1.set(2007, 0, 0); //2007.11.12
		d2.set(0, 10, 18);  //2024.10.18
		d3.set(0, 0, 28);   //2024.11.28

		cout << "d1应该是2007.11.22，实际为：";
		d1.show();
		cout << "d2应该是2024.10.18，实际为：";
		d2.show();
		cout << "d3应该是2024.11.28，实际为：";
		d3.show();
	...
	if (1) {
		...
		d2.set(2023, 2, 29); //2023.2.1
		d3.set(2024, 11, 32); //2024.11.1
		d4.set(2024, 13, 12); //2024.1.12

		cout << "d1应该是2000.2.29， 实际为：";
		d1.show();
		cout << "d2应该是2023.2.1，  实际为：";
		d2.show();
		cout << "d3应该是2024.11.1， 实际为：";
		d3.show();
		cout << "d4应该是2024.1.12， 实际为：";
		d4.show();
		...
		Date d12(2024, 2, 29), d13(2024, 10, 31);

		d12.set(2023, 0, 0); //2023.2.1
		d13.set(0, 11, 0);   //2024.11.1

		cout << "d12应该是2023.2.1， 实际为：";
		d12.show();
		cout << "d13应该是2024.11.1，实际为：";
		d13.show();
	...
	if (1) {
		...
		cout << "测试cout" << endl;
		cout << "d1应该是2024.11.22，实际为：" << d1 << endl;
	...
	if (1) {
		...
		cout << "请输入2024 11 22" << endl;
		cin >> d1;
		cout << "d1应该是2024.11.22， 实际为：" << d1 << endl;

		cout << "请输入2024 2 29" << endl;
		cin >> d1;
		cout << "d1应该是2024.2.29， 实际为：" << d1 << endl;
		...
		cin >> d1;
		cout << "d1应该是2024.1.10， 实际为：" << d1 << endl;

		cout << "请输入2024 11 31" << endl;
		cin >> d1;
		cout << "d1应该是2024.11.1， 实际为：" << d1 << endl;
	...
	if (1) {
		...
		cout << "d4应该是45617，实际为：" << int(d4) << endl;
	...
	if (1) {
		...
		d2 = d1 + 27;
		cout << "d2应该是2024.12.19，   实际为：" << d2 << endl;

		d2 = 27 + d1;
		cout << "d2应该是2024.12.19，   实际为：" << d2 << endl;

		d2 = d1 - 25;
		cout << "d2应该是2024.10.28，   实际为：" << d2 << endl;

		d1.set(2024, 2, 28);
		d2 = d1 + 3;
		cout << "d2应该是2024.3.2，     实际为：" << d2 << endl;
		...
		d1.set(2024, 1, 1);
		d2 = d1 - 5;
		cout << "d2应该是2023.12.27，   实际为：" << d2 << endl;

		d1.set(2023, 12, 31);
		d2 = d1 + 367;
		cout << "d2应该是2025.1.1，     实际为：" << d2 << endl;
		...
		cout << "d2-d1应该是-27，       实际为：" << d2 - d1 << endl;

		d1.set(2024, 11, 10);
		d2.set(2023, 11, 10);
		cout << "d1-d2应该是366，       实际为：" << d1 - d2 << endl;
		cout << "d2-d1应该是-366，      实际为：" << d2 - d1 << endl;

		d1.set(2023, 12, 10);
		d2.set(2022, 12, 10);
		cout << "d1-d2应该是365，       实际为：" << d1 - d2 << endl;
		cout << "d2-d1应该是-365，      实际为：" << d2 - d1 << endl;

		d1.set(2024, 11, 22);
		cout << "d1+27应该是2024.12.19，实际为：" << d1 + 27 << endl;
		cout << "27+d1应该是2024.12.19，实际为：" << 27 + d1 << endl;
		cout << "d1-25应该是2024.10.28，实际为：" << d1 - 25 << endl;
	...
	if (1) {
		...
		d1.set(2024, 11, 22);
		d2 = d1++;
		cout << "d1应该是2024.11.23，实际为：" << d1 << endl;
		cout << "d2应该是2024.11.22，实际为：" << d2 << endl;

		d1.set(2024, 12, 1);
		d2 = ++d1;
		cout << "d1应该是2024.12.2， 实际为：" << d1 << endl;
		cout << "d2应该是2024.12.2， 实际为：" << d2 << endl;

		d1.set(2024, 12, 1);
		d2 = d1--;
		cout << "d1应该是2024.11.30，实际为：" << d1 << endl;
		cout << "d2应该是2024.12.1， 实际为：" << d2 << endl;

		d1.set(2024, 12, 1);
		d2 = --d1;
		cout << "d1应该是2024.11.30，实际为：" << d1 << endl;
		cout << "d2应该是2024.11.30，实际为：" << d2 << endl;

		d1.set(2023, 12, 31);
		d2 = d1++;
		cout << "d1应该是2024.1.1，  实际为：" << d1 << endl;
		cout << "d2应该是2023.12.31，实际为：" << d2 << endl;

		d1.set(2024, 1, 1);
		d2 = d1--;
		cout << "d1应该是2023.12.31，实际为：" << d1 << endl;
		cout << "d2应该是2024.1.1，  实际为：" << d2 << endl;

		d1.set(2024, 2, 28);
		d2 = d1++;
		cout << "d1应该是2024.2.29， 实际为：" << d1 << endl;
		cout << "d2应该是2024.2.28， 实际为：" << d2 << endl;
		...
		d2 = d1--;
		cout << "d1应该是2024.2.29， 实际为：" << d1 << endl;
		cout << "d2应该是2024.3.1，  实际为：" << d2 << endl;
