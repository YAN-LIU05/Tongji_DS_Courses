...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, default='./config/qin_config/', help='The config directory.')
    parser.add_argument('--expid', type=str, default='QIN', help='The experiment id to run.')
